...
if has('nvim-0.7')
  ...
  nnoremap <silent> <expr> <A-1> (&filetype == NVIM_TREE ? "\<c-w>\<c-w>" : '').":BufferGoto 1<CR>"
  nnoremap <silent> <expr> <A-2> (&filetype == NVIM_TREE ? "\<c-w>\<c-w>" : '').":BufferGoto 2<CR>"
  nnoremap <silent> <expr> <A-3> (&filetype == NVIM_TREE ? "\<c-w>\<c-w>" : '').":BufferGoto 3<CR>"
  nnoremap <silent> <expr> <A-4> (&filetype == NVIM_TREE ? "\<c-w>\<c-w>" : '').":BufferGoto 4<CR>"
  nnoremap <silent> <expr> <A-5> (&filetype == NVIM_TREE ? "\<c-w>\<c-w>" : '').":BufferGoto 5<CR>"
  nnoremap <silent> <expr> <A-6> (&filetype == NVIM_TREE ? "\<c-w>\<c-w>" : '').":BufferGoto 6<CR>"
  nnoremap <silent> <expr> <A-7> (&filetype == NVIM_TREE ? "\<c-w>\<c-w>" : '').":BufferGoto 7<CR>"
  nnoremap <silent> <expr> <A-8> (&filetype == NVIM_TREE ? "\<c-w>\<c-w>" : '').":BufferGoto 8<CR>"
  nnoremap <silent> <expr> <A-9> (&filetype == NVIM_TREE ? "\<c-w>\<c-w>" : '').":BufferGoto 9<CR>"
  nnoremap <silent> <expr> <A-0> (&filetype == NVIM_TREE ? "\<c-w>\<c-w>" : '').":BufferLast<CR>"
  ...
  nnoremap <silent> <expr> <A-.> (&filetype == NVIM_TREE ? "\<c-w>\<c-w>" : '').":BufferNext<CR>"
  nnoremap <silent> <expr> <D-Right> (&filetype == NVIM_TREE ? "\<c-w>\<c-w>" : '').":BufferNext<CR>"
  nnoremap <silent> <expr> <A-Right> (&filetype == NVIM_TREE ? "\<c-w>\<c-w>" : '').":BufferNext<CR>"
  ...
  nnoremap <silent> <expr> <A-,> (&filetype == NVIM_TREE ? "\<c-w>\<c-w>" : '').":BufferPrevious<CR>"
  nnoremap <silent> <expr> <D-Left> (&filetype == NVIM_TREE ? "\<c-w>\<c-w>" : '').":BufferPrevious<CR>"
  nnoremap <silent> <expr> <A-Left> (&filetype == NVIM_TREE ? "\<c-w>\<c-w>" : '').":BufferPrevious<CR>"
  ...
  nnoremap <silent> <expr> <A-S-Left> (&filetype == NVIM_TREE ? "\<c-w>\<c-w>" : '').":BufferMovePrevious<CR>"
  " re-order current buffer to next(right)
  nnoremap <silent> <expr> <D-S-Right> (&filetype == NVIM_TREE ? "\<c-w>\<c-w>" : '').":BufferMoveNext<CR>"
  nnoremap <silent> <expr> <A-S-Right> (&filetype == NVIM_TREE ? "\<c-w>\<c-w>" : '').":BufferMoveNext<CR>"
else
