...
let g:coc_global_extensions = ['coc-yank', 'coc-lists', 'coc-snippets', 'coc-html', 'coc-xml', 'coc-clangd', 'coc-cmake', 'coc-pyright', 'coc-rust-analyzer', 'coc-go', 'coc-json', 'coc-tsserver', 'coc-css', '@yaegassy/coc-volar', 'coc-eslint', 'coc-prettier', 'coc-powershell', ]
