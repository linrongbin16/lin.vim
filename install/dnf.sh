...
$INSTALL_HOME/install_or_skip.sh "sudo dnf install -y ripgrep" "rg"
$INSTALL_HOME/install_or_skip.sh "sudo dnf install -y fd-find" "fdfind"
$INSTALL_HOME/install_or_skip.sh "sudo dnf install -y bat" "bat"
