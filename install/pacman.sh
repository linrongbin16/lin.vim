...
$INSTALL_HOME/install_or_skip.sh "yes | sudo pacman -S ripgrep" "rg"
$INSTALL_HOME/install_or_skip.sh "yes | sudo pacman -S fd" "fd"
$INSTALL_HOME/install_or_skip.sh "yes | sudo pacman -S bat" "bat"
