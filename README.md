...
3.  Install [Python3](https://www.python.org/downloads/), install packages with administrator **pip install pyOpenSSL pep8 flake8 pylint autopep8 yapf cpplint**.
...
8.  Install [NodeJs](https://nodejs.org/), choose **Add LLVM to PATH**, install packages with administrator **npm install -g --unsafe-perm js-beautify eslint tslint typescript-formatter remark-cli**.
