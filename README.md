...
7. Install [LLVM](http://releases.llvm.org/download.html) for C/C++, choose **Add LLVM to PATH**.
...
10. Install [NodeJs](https://nodejs.org/) for Javascript, during setup choose **Add Node to PATH**.
